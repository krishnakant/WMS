<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="DefectDefault.aspx.cs" Inherits="View_Forms_Master_DefectDefault" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
     function UpdatingInfo(btnid)
     {
        ...
        var Path='<%=strProjectName%>/View/Forms/Master/Defect.aspx?Code='+Code+'&GroupID='+GroupID;
 ...
 <fieldset class="sectionBorder">
        <legend>Defect Detail</legend>
    <div align="right" style="margin-right:4%;">
        <asp:Button ID="btnAdd" runat="server" OnRowCreated="gridView_RowCreated" CausesValidation="false" ToolTip="Add" Text="Add"
    ...
    <asp:GridView AutoGenerateColumns="false" Width="100%" OnRowDeleting="Role_RowDeleted" OnDataBound="eventhandlerSerialNo"
