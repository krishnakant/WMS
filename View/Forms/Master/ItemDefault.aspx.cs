...
public partial class View_Forms_Master_ItemDefault : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        strQuery = "select * from vw_wholeItemDetail order by Code";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(strProjectName+"/View/Forms/Master/Item.aspx");
    }
    ...
    protected void Role_RowDeleted(Object sender, GridViewDeleteEventArgs e)
    {
        ...
        string strQuery = "";
        DataTable dtinformation = new DataTable();
        strQuery = " execute usp_DeleteItemCode  " + hdnCodeID.Value + "";
        dtinformation = objQuerycontroller.ExecuteQuery(strQuery);
