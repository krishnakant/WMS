...
public partial class View_Forms_Master_CustumerVoiceDefault : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        strQuery = "select * from vw_wholeCVoiceDetail order by Code ";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(strProjectName+"/View/Forms/Master/CustomerVoice.aspx");
    }
    ...
    protected void Role_RowDeleted(Object sender, GridViewDeleteEventArgs e)
    {
        ...
        string strQuery = "";
        DataTable dtinformation = new DataTable();
        strQuery = " execute usp_DeleteCVoiceCode  " + hdnCodeID.Value + "";
        dtinformation = objQueryController.ExecuteQuery(strQuery);
