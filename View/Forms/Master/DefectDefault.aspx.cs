...
public partial class View_Forms_Master_DefectDefault : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        strQuery = "select * from vw_WholeDefectDetail order by Code";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(strProjectName+"/View/Forms/Master/Defect.aspx");
    }
    ...
    protected void Role_RowDeleted(Object sender, GridViewDeleteEventArgs e)
    {
        ...
        string strQuery = "";
        DataTable dtinformation = new DataTable();
        strQuery = " execute usp_DeleteDefectCode  " + hdnCodeID.Value + "";
        dtinformation = objQuerycontroller.ExecuteQuery(strQuery);
