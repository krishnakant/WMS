<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
    CodeFile="CulpritDefault.aspx.cs" Inherits="View_Forms_Master_CulpritDefault" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
     function UpdatingInfo(btnid)
     {
        ...
        var Path='<%=strProjectName%>/View/Forms/Master/Culprit.aspx?Code='+Code+'&GroupID='+GroupID;
    ...
    <fieldset class="sectionBorder">
        ...
        <div style="margin-left: 1%; width: 100%;">
            <asp:GridView AutoGenerateColumns="false" OnRowCreated="gridView_RowCreated" Width="100%"
                OnRowDeleting="Role_RowDeleted" OnDataBound="eventhandlerSerialNo" ID="gridDefault"
                runat="server">
                <Columns>
                    <asp:BoundField HeaderText="#" ItemStyle-HorizontalAlign="Center" ReadOnly="True" />
                    <asp:BoundField DataField="Code" HeaderText="Code" ReadOnly="True" ItemStyle-HorizontalAlign="Center" />
