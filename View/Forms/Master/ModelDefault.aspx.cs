...
public partial class View_Forms_Master_ModelDefault : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        strQuery = "select * from vw_wholeModelDetail order by ProductCode ";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(strProjectName+"/View/Forms/Master/Model.aspx");
    }
    ...
    protected void Role_RowDeleted(Object sender, GridViewDeleteEventArgs e)
    {
        ...
        string strQuery = "";
        DataTable dtinformation = new DataTable();
        strQuery = " execute usp_DeleteModelCode  " + hdnCodeID.Value + "";
        dtinformation = objQueryController.ExecuteQuery(strQuery);
