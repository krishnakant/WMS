<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="ModelDefault.aspx.cs" Inherits="View_Forms_Master_ModelDefault"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <script type="text/javascript">
     function UpdatingInfo(btnid)
     {
        ...
        var Path='<%=strProjectName%>/View/Forms/Master/Model.aspx?Code='+Code+'&GroupID='+GroupID;
 ...
 <fieldset class="sectionBorder">
    ...
    <asp:GridView AutoGenerateColumns="false"  OnRowCreated="gridView_RowCreated" OnRowDeleting="Role_RowDeleted" Width="100%"  OnDataBound="eventhandlerSerialNo"
       ...
       <Columns>
            ...
            <asp:BoundField DataField="ModelGroupName"  
                HeaderText="Group Name" ReadOnly="True" ItemStyle-HorizontalAlign="Center" />
            ...
            <asp:TemplateField HeaderText="Update" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:HiddenField ID="hdnCode" runat="server" Value='<%#Bind("ProductCode") %>' />
