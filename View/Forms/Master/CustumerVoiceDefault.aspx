<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="CustumerVoiceDefault.aspx.cs" Inherits="View_Forms_Master_CustumerVoiceDefault"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
     function UpdatingInfo(btnid)
     {
        ...
        var Path='<%=strProjectName%>/View/Forms/Master/CustomerVoice.aspx?Code='+Code+'&GroupID='+GroupID;
 ...
 <fieldset class="sectionBorder">
        <legend>Customer Voice Detail</legend>
