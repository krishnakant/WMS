<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
    CodeFile="DefectGroupWiseACR.aspx.cs" Inherits="View_Forms_Reports_DefectGroupWiseACR"
 ...
 function ClientValidateModel(source, arguments){
   ...
   //******************* Validation of fromdate todat  ******************************************//
    ...
    <fieldset class="sectionBorder">
        <legend>Defect Group Wise ACR Detail</legend>
                ...
                <td class="cssLabel">
                    <asp:Label ID="lblGroupName" runat="server" Text="Group:"></asp:Label>
                     ...
                     <asp:Panel  BorderWidth="1px" ID="Panel1" runat="server" BorderColor="#00678e"
                        ScrollBars="Vertical">
                        <asp:CheckBoxList ID="chkDefectCode" ToolTip="select Customer Voice Code"
