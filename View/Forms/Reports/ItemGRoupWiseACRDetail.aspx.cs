...
public partial class View_Forms_Reports_ItemGRoupWiseACRDetail : System.Web.UI.Page
{
    ...
    public void getItemCodeGroup()
    {
        ...
        if (dtinformation != null)
        {
            ...
            {
                chkItemCode.DataSource = dtinformation;
                chkItemCode.DataValueField = "ItemCodeGroupID";
                chkItemCode.DataTextField = "ItemGRoupName";
    ...
    public DataTable getTable()
    {
        ...
        string Groupparameter = getIntegerParameter(chkItemCode, "ItemGroupID");
        if (chkAllchkItemCodeCode.Checked)
        {
            strQuery = "select *,'All' as Model  from VW_ACRBulkGroupDetailWithRegion where  ItemGroupID<>0  and  " + strwhrprm + " order by ITEM_CODE";
            strGroup = "Model";
        }
        else
        {
            strQuery = "select * from VW_ACRBulkGroupDetailWithRegion where  (" + Groupparameter + ")  and  " + strwhrprm + " order by ITEM_CODE";
            strGroup = "ItemGRoupName";
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        strParameter = getchkList(chkItemCode, "ItemGRoupName");
        str = str + "<table width='50%' border='1' cellpadding='0' cellspacing='0'>";
        str = str + "<tr><td style='font-size:small;font-weight:bold;'>Report For:</td><td style='font-size:small;font-weight:bold;'>Item Group Wise ACR Detail</td></tr>";
