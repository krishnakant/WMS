<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" ValidateRequest="false"
    AutoEventWireup="true" CodeFile="ItemGRoupWiseACRDetail.aspx.cs" Inherits="View_Forms_Reports_ItemGRoupWiseACRDetail"
    Title="WMS" %>
 ...
 function ClientValidateModel(source, arguments){
        ...
        function getValidation()
         {
              ...
              var checkCVoiceCode=getCheckBoxStatus('ctl00_ContentPlaceHolder1_chkItemCode');
   ...
   //******************* Validation of fromdate todat  ******************************************//
    ...
    <fieldset class="sectionBorder">
        <legend>Item Group Wise ACR Detail</legend>
                ...
                <td class="cssLabel">
                    <asp:Label ID="lblGroupName" runat="server" Text="Group:"></asp:Label>
                     ...
                     <asp:Panel  Height="180px" BorderWidth="1px" ID="Panel1" runat="server" BorderColor="#00678e"
                        ScrollBars="Vertical">
                        <asp:CheckBoxList ID="chkItemCode" ToolTip="select Customer Voice Code"
                            RepeatColumns="5" runat="server">
                        </asp:CheckBoxList>
                    </asp:Panel>
                    <input type="checkbox" id="chkAllchkItemCodeCode" runat="server" onclick="javascript:SetAllCheckBoxes('ctl00_ContentPlaceHolder1_chkItemCode',this.id);" />Select
                    All
                </td>
