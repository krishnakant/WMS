<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/master/WMSModelWindow.master" AutoEventWireup="true" CodeFile="SalesPopup.aspx.cs" Inherits="View_Forms_Reports_SalesPopup"  %>
...
<fieldset><legend>Sales</legend>
 ...
 <div style="overflow: auto; height: 500px; width: 100%;" id="divGrid_PopUp">
            <asp:GridView ID="grdSalesData" runat="server"
                ...
                BorderWidth="1px" CellPadding="3" OnPageIndexChanging="grdacrData_Paging" AutoGenerateColumns="false" EmptyDataText="No Data Found"  AllowPaging="true" PageSize="500" >
                <Columns>
