<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/MasterPage.master" CodeFile="CulpritCodeWiseACRDetail.aspx.cs" Inherits="View_Forms_Reports_CulpritCodeWiseACRDetail" ValidateRequest="false" %>
  ...
  $(document).ready(function()
        ...
        function getValidation()
         {
              ...
              var checkCVoiceCode=getCheckBoxStatus('ctl00_ContentPlaceHolder1_chkCulCode');
         
              if(checkCVoiceCode=='0')
               {
                alert('Please select atleast one Code');
                 return false;
                }
   //******************* Validation of fromdate todat  ******************************************//
    ...
    <fieldset class="sectionBorder">
        <legend>Culprit Code Wise ACR Detail</legend>
           <table border="0" cellpadding="0" cellspacing="0" width="950px">
            <tr>
                <td class="cssLabel">
                    <asp:Label ID="lblGroupName" runat="server" Text="Culprit Code:"></asp:Label>
                    </td><td colspan="2">
                    <div style="height:320px;overflow:scroll;">
                     <asp:Panel  BorderWidth="1px" ID="Panel1" runat="server" BorderColor="#00678e"
                        ScrollBars="Vertical">
                        <asp:CheckBoxList ID="chkCulCode" ToolTip="select Culprit Code"
                            RepeatColumns="10" runat="server">
                        </asp:CheckBoxList>
                    </asp:Panel></div>
                    <input type="checkbox" id="chkAllCulCode" runat="server"  onclick="javascript:SetAllCheckBoxes('ctl00_ContentPlaceHolder1_chkCulCode',this.id);" />Select
                    All
                </td>
