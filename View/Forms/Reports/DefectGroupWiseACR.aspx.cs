...
public partial class View_Forms_Reports_DefectGroupWiseACR : System.Web.UI.Page
{
    ...
    public void getDefectGroup()
    {
        ...
        if (dtinformation != null)
        {
            ...
            if (dtinformation.Rows.Count > 0)
            {
                ...
                chkDefectCode.DataValueField = "DefectGroupID";
                chkDefectCode.DataTextField = "GroupName";
    ...
    public DataTable getTable()
    {
        ...
        string Groupparameter = getIntegerParameter(chkDefectCode, "DefectGroupID");
