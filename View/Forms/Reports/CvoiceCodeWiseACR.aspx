<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/MasterPage.master" ValidateRequest="false" CodeFile="CvoiceCodeWiseACR.aspx.cs" Inherits="View_Forms_Reports_CvoiceCodeWiseACR" %>
 ...
 function ClientValidateModel(source, arguments){
   ...
   //******************* Validation of fromdate todat  ******************************************//
    ...
    <fieldset class="sectionBorder">
        <legend>Customer Voice Code Wise ACR Detail</legend>
        <table border="0" cellpadding="0" cellspacing="0"  width="950px">
            <tr>
                <td class="cssLabel">
                    <asp:Label ID="lblGroupName" runat="server" Text="Customer Voice Code:"></asp:Label>
                    </td><td colspan="2">
        ...
        <br />
        <div class="cssButtonPanel" style="width: 1150px;">
