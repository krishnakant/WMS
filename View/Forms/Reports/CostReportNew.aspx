<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
    CodeFile="CostReportNew.aspx.cs" Inherits="View_Forms_Reports_CostReportNew"
            ...
            <tr>
                <td colspan="4" width="400px">
                    <asp:RadioButtonList ID="rdoType" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Selected="True" Value="0" onclick="getMonthYear(this.value);">Month Wise</asp:ListItem>
                        <asp:ListItem Value="1" onclick="getMonthYear(this.value);">Quarter Wise</asp:ListItem>
                    </asp:RadioButtonList>
                    <div id="tdProdMonth">
