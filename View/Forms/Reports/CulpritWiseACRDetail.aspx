<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" ValidateRequest="false"
    AutoEventWireup="true" CodeFile="CulpritWiseACRDetail.aspx.cs" Inherits="View_Forms_Reports_CulpritWiseACRDetail"
    Title="WMS" %>
  ...
  $(document).ready(function()
   ...
   //******************* Validation of fromdate todat  ******************************************//
    ...
    <fieldset class="sectionBorder">
        <legend>Culprit Group Wise ACR Detail</legend>
                ...
                <td class="cssLabel">
                    <asp:Label ID="lblGroupName" runat="server" Text="Group:"></asp:Label>
                     ...
                     <asp:Panel  BorderWidth="1px" ID="Panel1" runat="server" BorderColor="#00678e"
                        ScrollBars="Vertical">
                        <asp:CheckBoxList ID="chkCulCode" ToolTip="select Customer Voice Code"
