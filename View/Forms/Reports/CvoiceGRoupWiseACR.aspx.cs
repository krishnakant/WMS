...
public partial class View_Forms_Reports_CvoiceGRoupWiseACR : System.Web.UI.Page
{
    ...
    public void getCVoiceGroup()
    {
        ...
        if (dtinformation != null)
        {
            ...
            if (dtinformation.Rows.Count > 0)
            {
                ...
                chkCVoiceCode.DataValueField = "CVoiceGroupID";
                chkCVoiceCode.DataTextField = "GroupName";
                chkCVoiceCode.DataBind();
                //foreach (ListItem list in chkCVoiceCode.Items)
                //{
                //    list.Selected = true;
                //}
    ...
    public DataTable getTable()
    {
        ...
        //}
        string Groupparameter = getIntegerParameter(chkCVoiceCode, "CVoiceGroupID");
        if (chkAllCVoiceCode.Checked)
        {
            strQuery = "select *,'All' as Model from VW_ACRBulkGroupDetailWithRegion where CVoiceGroupID<>0  and " + strwhrprm + " order by CVOICE";
            strGroup = "Model";
        }

        else
        {
            strQuery = "select * from VW_ACRBulkGroupDetailWithRegion where ("+Groupparameter+")  and  " + strwhrprm + " order by CVOICE";
            strGroup = "CVoiceGroupName";
