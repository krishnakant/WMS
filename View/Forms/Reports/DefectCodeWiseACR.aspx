<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/MasterPage.master"  CodeFile="DefectCodeWiseACR.aspx.cs" Inherits="View_Forms_Reports_DefectCodeWiseACR"  ValidateRequest="false"%>
 ...
 function ClientValidateModel(source, arguments){
        ...
        function getValidation()
         {
              ...
              var checkCVoiceCode=getCheckBoxStatus('ctl00_ContentPlaceHolder1_chkDefectCode');
   ...
   //******************* Validation of fromdate todat  ******************************************//
    ...
    <fieldset class="sectionBorder">
        <legend>Defect Code Wise ACR Detail</legend>
       
         <table border="0" cellpadding="0" cellspacing="0" width="950px">
            <tr>
                <td class="cssLabel">
                    <asp:Label ID="lblGroupName" runat="server" Text="Defect Code:"></asp:Label>
                    </td><td colspan="2">
                    <div style="height:280px;overflow:scroll;">
                     <asp:Panel  BorderWidth="1px" ID="Panel1" runat="server" BorderColor="#00678e"
                        ScrollBars="Vertical">
                        <asp:CheckBoxList ID="chkDefectCode" ToolTip="select Defect Code"
                            RepeatColumns="10" runat="server">
                        </asp:CheckBoxList>
                    </asp:Panel></div>
                    <input type="checkbox" id="chkAllDefectCode" runat="server" onclick="javascript:SetAllCheckBoxes('ctl00_ContentPlaceHolder1_chkDefectCode',this.id);" />Select
                    All
                </td>
