...
public partial class View_Forms_Reports_SalesPopup : System.Web.UI.Page
{
    ...
    public DataTable getTable()
    {
        ...
        if (hdnRegion.Value == "0")
        {
            strQuery += " and Month(Date)=" + hdnMonth.Value + " and  Year(Date)=" + hdnYear.Value + " ";
        }
        else
        {
