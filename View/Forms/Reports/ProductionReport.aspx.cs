...
public partial class View_Forms_Reports_ProductionReport : System.Web.UI.Page
{
    ...
    public DataTable getTable()
    {
        ...
        string strQuery = "select * from vw_ProductionReportData where (" + strModelParameter + ") and (" + strModelCategoryParameter + ") and (" + strModelClutchParameter + ") and (" + strModelSpecialParameter + ")";
