<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
    CodeFile="TopContributors.aspx.cs" ValidateRequest="false" Inherits="View_Forms_Reports_TopContributors" %>
...
function ExportGridWithSelection( strid )
        ...
        function getselection()
       {
            ...
            var creteDiv='<br /><table cellpadding=0 cellspacing=0 border=1><tr><td class=cssLabel style="width:100%;align:center;"><b>Top Contributors</b></td></tr><tr><td class="cssLabel"><b>Model: '+ Model +'</b></td></tr><tr><td class="cssLabel">'+ TrUnWty +'</td></tr>';
            creteDiv +='</table><br />';
            return creteDiv;
       }
    ...
    <fieldset class="sectionBorder">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <span class="cssLabel">Top</span>
                    <asp:TextBox ID="txtContributors" Text="10" runat="server" Width="50px"></asp:TextBox><span
                        class="cssLabel"> Contributors</span>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Numeric values only "
                        ValidationExpression="^([0-9]*\s?[0-9]*)+$" ControlToValidate="txtContributors"></asp:RegularExpressionValidator>
                </td>
        ...
        <div id="print_Grid" style="overflow: auto; height: 250px;">
            <asp:GridView AutoGenerateColumns="false" OnRowCreated="OnRowCreated" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Failure_Per_K" HeaderText="Failure/1000" ItemStyle-HorizontalAlign="Center"
                    ...
                    <asp:BoundField DataField="Value" HeaderText="Value" ItemStyle-HorizontalAlign="Center"
                        HeaderStyle-HorizontalAlign="Center" HtmlEncode="false" DataFormatString="{0:F2}" />
                    <asp:BoundField DataField="Cost_Per_Tractor" HeaderText="Cost Per Tractor" ItemStyle-HorizontalAlign="Center"
                        HeaderStyle-HorizontalAlign="Center" HtmlEncode="false" DataFormatString="{0:F2}" />
                    <asp:BoundField DataField="Cumulative_Cost_Per_Tractor" HeaderText="Cumulative Cost Per Tractor"
                        ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HtmlEncode="false"
                        DataFormatString="{0:F2}" />
                    <asp:BoundField DataField="Percentage_Contribution" HeaderText="% Contribution" ItemStyle-HorizontalAlign="Center"
                        HeaderStyle-HorizontalAlign="Center" HtmlEncode="false" DataFormatString="{0:F2}" />
                </Columns>
