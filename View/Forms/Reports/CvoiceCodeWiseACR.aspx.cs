...
public partial class View_Forms_Reports_CvoiceCodeWiseACR : System.Web.UI.Page
{
    ...
    public void getCVoiceGroup()
    {
        ...
        //vaibhav strQuery = "select * from CVoiceGroup  order by GRoupName";
        strQuery = "select Code,(Convert(varchar,Code)+' ('+ Description+')') AS Description from CustomerVoice";
    ...
    public DataTable getTable()
    {
        ...
        //}
        //vaibhav string Groupparameter = getIntegerParameter(chkCVoiceCode, "CVoiceGroupID");
        string Groupparameter = getIntegerParameter(chkCVoiceCode, "CVOICE");
        if (chkAllCVoiceCode.Checked)
        {
            //vaibhav strQuery = "select *,'All' as Model from VW_ACRBulkGroupDetailWithRegion where CVoiceGroupID<>0  and " + strwhrprm + " order by CVOICE";
            //strGroup = "Model";

            strQuery = "select *,'All' as Model from vw_AcrBulkData where " + strwhrprm + " ";

        }

        else
        {
            //vaibhav strQuery = "select * from VW_ACRBulkGroupDetailWithRegion where ("+Groupparameter+")  and  " + strwhrprm + " order by CVOICE";
            //strGroup = "CVoiceGroupName"; vw_AcrBulkData
            strQuery = "select * from vw_AcrBulkData where (" + Groupparameter + ")  and  " + strwhrprm + " ";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        strParameter=getchkList(chkCVoiceCode,"GroupName");
        str = str + "<table width='50%' border='1' cellpadding='0' cellspacing='0'>";
        str = str + "<tr><td style='font-size:small;font-weight:bold;'>Report For:</td><td style='font-size:small;font-weight:bold;'>Customer Voice Group Wise ACR Detail</td></tr>";
