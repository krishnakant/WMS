<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="CVoiceConfigurator.aspx.cs" Inherits="View_Forms_Configurator_CVoiceConfigurator" Title="WMS" %>
...
function checkValidation()
{
   ...
   if(!check){alert('please select Cvoice Code'); return false;}
...
<legend>Customer Voice Configurator</legend>
    <table width="90%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <asp:Panel Height="200px" BorderWidth="1px" ID="pnlItemCodeList" runat="server" ScrollBars="Vertical">
                <asp:CheckBoxList ID="chkCodeList" CellSpacing="5" ToolTip="select Code" RepeatColumns="3" runat="server">
                </asp:CheckBoxList>
                </asp:Panel>
