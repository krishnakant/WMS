<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
    CodeFile="ItemConfigurator.aspx.cs" Inherits="View_Forms_Configurator_ItemConfigurator"
    Title="WMS" %>
...
<legend>Item Configurator</legend>
    ...
    <table width="90%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <asp:Panel Height="200px" BorderWidth="1px" ID="pnlItemCodeList" runat="server" ScrollBars="Vertical">
                <asp:CheckBoxList ID="chkItemCodeList" CellSpacing="5" ToolTip="select Item Code" RepeatColumns="3" runat="server">
                </asp:CheckBoxList>
                </asp:Panel>
