<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
    CodeFile="ShowItemCodeByGroupName.aspx.cs" Inherits="View_Forms_Configurator_ShowItemCodeByGroupName"
    Title="WMS" %>
...
function ClientValidateGRoupList(source, arguments){
      if (document.getElementById('ctl00_ContentPlaceHolder1_ddlItemGRoupList').value!=0)
...
<legend>Show Item Code By Group </legend>
    <table width="90%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlItemGRoupList" runat="server">
                   ...
                   <asp:CustomValidator ID="CustomValidator" ControlToValidate="ddlItemGRoupList" runat="server"
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <asp:CheckBoxList  ID="chkItemCodeList" ToolTip="select Code" CellSpacing="5"
                    RepeatColumns="3" runat="server">
                </asp:CheckBoxList>
                </asp:Panel>
                    <input type="checkbox" checked id="chkSelectAll" onclick="javascript:SetAllCheckBoxes('ctl00_ContentPlaceHolder1_chkItemCodeList',this.id);" />Select All
            </td>
        </tr>
    </table>
