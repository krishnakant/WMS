...
public partial class View_Forms_Setting_CustomerVoiceGroupSetting : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        strQuery = "select CVoiceGroupID,GroupName from CVoiceGroup order by GroupName";
    ...
    public void saveGroupName()
    {
        ...
        GroupID = objController.SaveCVoiceGroup(objcUI, null);
        if (GroupID == 0)
        {
            string strjscript = "<script language='javascript' type='text/javascript'>";
    ...
    public void DeleteCvoiceGroup()
    {
        int StatusID = 0;
        objcUI.source = "Cvoice";
    ...
    public void Record_Updating(Object sender, GridViewUpdateEventArgs e)
    {
        ...
        if (dtKey["GroupName"].ToString() != txtGroupName.Text.Trim())
        {
            ...
            objcUI.source = "Cvoice";
            objcUI.GroupID = Convert.ToInt32(dtKey["CVoiceGroupID"].ToString());
