<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerVoiceGroupSetting.aspx.cs" Inherits="View_Forms_Setting_CustomerVoiceGroupSetting"  %>
...
<fieldset class="sectionBorder"><legend>Customer Voice Group Setting</legend>

    <table>
        <tr>
            <td class="cssLabel">
                <asp:Label ID="lblGroupName" runat="server" Text="Customer Voice Group Name:"></asp:Label>
            </td>
            <td id="trtxtGroupName">
                <asp:TextBox ID="txtGroupName" ToolTip="Customer Voice Group Name" Width="120px" MaxLength="50" runat="server"></asp:TextBox>
    ...
    <asp:GridView ID="GridView1" OnRowCreated="gridView_RowCreated" DataKeyNames="CVoiceGroupID,GroupName" OnRowUpdating="Record_Updating" OnDataBound="eventhandlerSerialNo" OnRowCancelingEdit="Record_cancel"  OnRowDeleting="Role_RowDeleted" OnRowEditing="Record_Edit"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Update">
                <ItemTemplate>
                <asp:HiddenField ID="hdnGroupID" runat="server" Value='<%#Bind("CVoiceGroupID") %>' />
