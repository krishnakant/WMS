<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
    CodeFile="CulpritGroupSetting.aspx.cs" Inherits="View_Forms_Setting_CulpritGroupSetting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 function DeletingInfo(btnid)
    ...
    <fieldset class="sectionBorder">
        <legend>Culprit Group Setting</legend>
        <table>
            <tr>
                <td class="cssLabel">
                    <asp:Label ID="lblGroupName" runat="server" Text="Culprit Group Name:"></asp:Label>
                </td>
                <td id="trtxtGroupName">
                    <asp:TextBox ID="txtGroupName" ToolTip="Culprit Group Name" Width="120px" MaxLength="50"
        ...
        <asp:GridView ID="GridView1" OnRowCreated="gridView_RowCreated" DataKeyNames="CulpritGroupID,GRoupName"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Update">
                    <ItemTemplate>
                        <asp:HiddenField ID="hdnGroupID" runat="server" Value='<%#Bind("CulpritGroupID") %>' />
