...
public partial class View_Forms_Setting_ItemGroupSettingt : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        strQuery = "select ItemCodeGroupID,ItemGRoupName from ItemGRoup order by ItemGRoupName";
    ...
    public void saveGroupName()
    {
        ...
        GroupID = objController.SaveGroup(objcUI, null);
        if (GroupID == 0)
        {
            string strjscript = "<script language='javascript' type='text/javascript'>";
    ...
    public void Record_Updating(Object sender, GridViewUpdateEventArgs e)
    {
        ...
        if (dtKey["ItemGRoupName"].ToString() != txtGroupName.Text.Trim())
        {
            objcUI.GroupName = GroupName;
            objcUI.source = "Item";
            objcUI.GroupID = Convert.ToInt32(dtKey["ItemCodeGroupID"].ToString());
