...
public partial class View_Forms_Setting_DefectGroupSetting : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        strQuery = "select DefectGroupID,GroupName from DefectGroup order by GroupName";
    ...
    public void saveGroupName()
    {
        ...
        GroupID = objController.SaveDefectGroup(objcUI, null);
        if (GroupID == 0)
        {
            string strjscript = "<script language='javascript' type='text/javascript'>";
    ...
    public void DeleteDefectGroup()
    {
        int StatusID = 0;
        objcUI.source = "Defect";
    ...
    public void Record_Updating(Object sender, GridViewUpdateEventArgs e)
    {
        ...
        if (dtKey["GroupName"].ToString() != txtGroupName.Text.Trim())
        {
            ...
            objcUI.source = "Defect";
            objcUI.GroupID = Convert.ToInt32(dtKey["DefectGroupID"].ToString());
