<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="ItemGroupSettingt.aspx.cs" Inherits="View_Forms_Setting_ItemGroupSettingt"  %>
...
<fieldset class="sectionBorder"><legend>Item Group Setting</legend>

    <table>
        <tr>
            <td class="cssLabel">
                <asp:Label ID="lblGroupName" runat="server" Text="Item Group Name:"></asp:Label>
            </td>
            <td id="trtxtGroupName">
                <asp:TextBox ID="txtGroupName" ToolTip="Item Group Name"  Width="120px" MaxLength="50" runat="server"></asp:TextBox>
    ...
    <asp:GridView ID="GridView1" OnRowCreated="gridView_RowCreated" DataKeyNames="ItemCodeGroupID,ItemGRoupName" OnRowUpdating="Record_Updating" OnDataBound="eventhandlerSerialNo" OnRowCancelingEdit="Record_cancel"  OnRowDeleting="Role_RowDeleted" OnRowEditing="Record_Edit"
        ...
        <Columns>
            <asp:BoundField HeaderText="#" ReadOnly="True">
             ...
             <asp:TemplateField HeaderText="Group Name">
                    <ItemTemplate>
                        <asp:Label ID="lblName" runat="server" Text='<%#Bind("ItemGRoupName")%>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtGroupName" Text='<%#Bind("ItemGRoupName")%>' runat="server"></asp:TextBox>
                    </EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Update">
                <ItemTemplate>
                <asp:HiddenField ID="hdnGroupID" runat="server" Value='<%#Bind("ItemCodeGroupID") %>' />
