...
public partial class View_Forms_Exceptions_CvoiceException : System.Web.UI.Page
{
    ...
    public void getCvoiceCodeDetail()
    {

        string strQuery = "";
        DataTable dtinformation = new DataTable();
        strQuery = "select distinct CVOICE as Code from acrbulktemp where IsCVoiceEx=1 and CVOICE<>''";
