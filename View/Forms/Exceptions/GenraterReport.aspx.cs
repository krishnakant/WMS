...
public partial class View_Forms_Exceptions_GenraterReport : System.Web.UI.Page
{
    ...
    public DataTable GetTable()
    {
        ...
        if (Convert.ToInt32(ddlselection.SelectedValue) == 1)
        {
            ...
            strQuery = " execute usp_getCostBulk '" + drpYear.SelectedItem.Text + "', " + strFin + "," + Last + "," + type + ",'" + Model_Code + "'," + strModelCategoryID + "," + strClutchTypeID + "," + strModelSpecialID + "," + strSum + "," + intWhereQueryHMR + "," + rdoData.SelectedValue + "," + strwhrprm + "," + Month + ",'" + strYear + "','" + strRegionID + "'";
        }
        else
            if (Convert.ToInt32(ddlselection.SelectedValue)== 2)
            {
                ...
                if (Convert.ToInt32(ddlselection.SelectedValue) == 3)
                {
                    ...
                    strQuery = " execute usp_SalesCostNewModel '" + drpYear.SelectedItem.Text + "', " + strFin + "," + Last + ",'" + Model_Code + "'," + strModelCategoryID + "," + strClutchTypeID + "," + strModelSpecialID + "," + strSum + "," + 0 + "," + Month + ",'" + strRegionID + "'";
