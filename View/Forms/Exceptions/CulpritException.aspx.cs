...
public partial class View_Forms_Exceptions_CulpritException : System.Web.UI.Page
{
    ...
    public void getCulpritCodeDetail()
    {
        ...
        strQuery = "select distinct [CUL CODE] as Code from acrbulktemp where IsCulpritEx=1";
        ...
        if (dtinformation != null)
        {
            ...
            if (dtinformation.Rows.Count > 0)
            {
                ...
                chkCodeList.DataTextField = "Code";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (GroupID > 0)
        {
            ...
            //}
            SaveBulkAcr();
            Response.Redirect("/WMS/View/Forms/Exceptions/CulpritException.aspx");
        }
    }
