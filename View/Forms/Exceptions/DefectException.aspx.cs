...
public partial class View_Forms_Exceptions_DefectException : System.Web.UI.Page
{
    ...
    public void getDefectCodeDetail()
    {
        ...
        strQuery = "select distinct [DEF] as Code from acrbulktemp where IsDefectEx=1";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (GroupID > 0)
        {
            ...
            //}
            SaveBulkAcr();
            Response.Redirect("/WMS/View/Forms/Exceptions/DefectException.aspx");
        }
    }
