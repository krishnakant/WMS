<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="Exception.aspx.cs" Inherits="View_Forms_Exceptions_Exception" %>
...
function GotoException(id)
{
            ...
            if(ExRef=='Model')
            {
                var url = '/WMS/View/Forms/Exceptions/'+ExRef+'ExceptionBulk.aspx';
            }
            else if(ExRef=='Tractor No')
            {
                 var url = '/WMS/View/Forms/Exceptions/MissingTractorNo.aspx';
            }            
            else
            {
                var url = '/WMS/View/Forms/Exceptions/'+ExRef+'Exception.aspx';
            }
...
<asp:GridView ID="grdExceptionCount" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" EmptyDataText="No Data Found">
