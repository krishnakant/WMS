<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="ProductionException.aspx.cs" Inherits="View_Forms_Exceptions_ProductionException" %>
...
function GotoException(id)
{
            ...
            if(ExRef == 'Model')
            {
                 url = '<%=strProjectName%>/View/Forms/Exceptions/'+ExRef+'ExceptionNew.aspx';
            }
            else
            {
                url = '<%=strProjectName%>/View/Forms/Exceptions/'+ExRef+'Exception.aspx';
            }
