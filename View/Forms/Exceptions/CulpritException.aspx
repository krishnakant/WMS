<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="CulpritException.aspx.cs" Inherits="View_Forms_Exceptions_CulpritException" Title="WMS" %>
...
<legend>Culprit Exceptions</legend>
    <table width="90%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <asp:Panel Height="200px" BorderWidth="1px" ID="pnlItemCodeList" runat="server" ScrollBars="Vertical">
                <asp:CheckBoxList ID="chkCodeList" CellSpacing="5" ToolTip="select Code" RepeatColumns="5" runat="server">
                </asp:CheckBoxList>
                </asp:Panel>
