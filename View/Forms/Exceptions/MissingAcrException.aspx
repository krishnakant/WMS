<%@ Page Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
    CodeFile="MissingAcrException.aspx.cs" Inherits="View_Forms_Exceptions_MissingAcrException" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <fieldset class="sectionBorder">
            <legend>Exceptions</legend>
            <table cellspacing="0" cellpadding="0" width="100%" style="overflow-x: auto; overflow-y: auto;">
                <tr>
                    <td>
                        <asp:GridView ID="grdAcrException" runat="server" BackColor="White"
